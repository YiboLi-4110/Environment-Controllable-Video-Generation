...
# --- Real-world dataset ---
DATASET_BASE_PATH_REAL="datasets/gravity/train/real_8k"
DATASET_METADATA_PATH_REAL="datasets/gravity/train/real_8k.csv"
...
WARMUP_STEPS=200  # optimizer steps for Phase-1 warm-up (~10% of Phase-1 total)
...
accelerate launch \
  ...
  ${DATA_VOLUME:+--data_volume ${DATA_VOLUME}}
